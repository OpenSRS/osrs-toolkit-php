...
class SetDomainMailboxLimits extends Mail {
	...
	private function _validateObject() {
		...
		if(
			!isset( $this->_dataObject->data->admin_username ) ||
			$this->_dataObject->data->admin_username == ""
		) {
		...
		if(
			!isset( $this->_dataObject->data->admin_password ) ||
			$this->_dataObject->data->admin_password == ""
		) {
		...
		if(
			!isset( $this->_dataObject->data->admin_domain ) ||
