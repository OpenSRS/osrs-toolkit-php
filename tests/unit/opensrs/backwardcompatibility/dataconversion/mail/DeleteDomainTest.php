...
use opensrs\backwardcompatibility\dataconversion\mail\DeleteDomain;

/**
 * @group backwardcompatibility
 * @group dataconversion
 * @group publishing
 * @group BC_MailDeleteDomain
 */
class BC_DeleteDomainTest extends PHPUnit_Framework_TestCase
{
