...
use opensrs\backwardcompatibility\dataconversion\mail\ChangeDomain;

/**
 * @group backwardcompatibility
 * @group dataconversion
 * @group publishing
 * @group BC_MailChangeDomain
 */
class BC_ChangeDomainTest extends PHPUnit_Framework_TestCase
{
