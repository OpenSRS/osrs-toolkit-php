...
use opensrs\backwardcompatibility\dataconversion\mail\CreateDomain;

/**
 * @group backwardcompatibility
 * @group dataconversion
 * @group publishing
 * @group BC_MailCreateDomain
 */
class BC_CreateDomainTest extends PHPUnit_Framework_TestCase
{
