...
use opensrs\backwardcompatibility\dataconversion\publishing\GetServiceInfo;

/**
 * @group backwardcompatibility
 * @group dataconversion
 * @group publishing
 * @group BC_PublishingGetServiceInfo
 */
class BC_GetServiceInfoTest extends PHPUnit_Framework_TestCase
{
