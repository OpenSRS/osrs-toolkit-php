...
use opensrs\backwardcompatibility\dataconversion\publishing\LetExpire;

/**
 * @group backwardcompatibility
 * @group dataconversion
 * @group publishing
 * @group BC_PublishingLetExpire
 */
class BC_LetExpireTest extends PHPUnit_Framework_TestCase
{
