...
use opensrs\backwardcompatibility\dataconversion\publishing\GetControlPanelUrl;

/**
 * @group backwardcompatibility
 * @group dataconversion
 * @group publishing
 * @group BC_PublishingGetControlPanelUrl
 */
class BC_GetControlPanelUrlTest extends PHPUnit_Framework_TestCase
{
