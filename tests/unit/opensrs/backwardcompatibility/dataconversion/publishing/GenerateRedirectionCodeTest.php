...
use opensrs\backwardcompatibility\dataconversion\publishing\GenerateRedirectionCode;

/**
 * @group backwardcompatibility
 * @group dataconversion
 * @group publishing
 * @group BC_PublishingGenerateRedirectionCode
 */
class BC_GenerateRedirectionCodeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testValidDataConversion()
    {
        ...
        $ns = new GenerateRedirectionCode();
