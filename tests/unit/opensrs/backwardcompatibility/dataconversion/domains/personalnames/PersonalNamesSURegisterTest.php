...
use opensrs\backwardcompatibility\dataconversion\domains\personalnames\PersonalNamesSURegister;

/**
 * @group backwardcompatibility
 * @group dataconversion
 * @group cookie
 * @group BC_PersonalNamesSURegister
 */
class BC_PersonalNamesSURegisterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testValidDataConversion()
    {
        ...
        $ns = new PersonalNamesSURegister();
