...
for ($i=0; $i<=50; $i++){
	if (isSet ($_POST["nstld_" . $i])) array_push ($formnsSelectedDomainArray, $_POST["nstld_" . $i]);
	if (isSet ($_POST["lktld_" . $i])) array_push ($formlkSelectedDomainArray, $_POST["lktld_" . $i]);
}
